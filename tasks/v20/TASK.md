...
- description: "【nebula】使用工作區檔案瀏覽工具，依序讀取以下12個目標路徑的檔案內容（檔案不存在則記入 skipped_files，不報錯繼續）：\n\
    ...
    \  \"files\": [{\"path\": \"data/m13_regime_state.json\", \"content\": \"...完整UTF-8字串...\"\
    , \"size_bytes\": N}, ...],\n  \"skipped_files\": [\"data/hypothesis_tracker.json\"\
    , ...],\n  \"cleanup_summary\": {\"deleted_files\": [...]},\n  \"total_trades\"\
    : N,\n  \"scan_timestamp_cst\": \"2026-MM-DD HH:MM CST\"\n}"
  agent_slug: nebula
  format_guide: '輸出 JSON：{files: [{path, content(UTF-8字串), size_bytes}], skipped_files:
    [], cleanup_summary: {deleted_files: []}, total_trades: N, scan_timestamp_cst:
    str}'
